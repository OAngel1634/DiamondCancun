...
$stmt = $pdo->prepare("
    SELECT o.*, t.nombre AS tour_nombre, t.imagen_principal
    FROM opiniones o
...
<head>
    ...
    <title>Opiniones - Diamond Bright</title>
    ...
    <div class="container">
        <div class="profile-header">
            <div class="welcome-section">
                <h1>Opiniones - Diamond Bright</h1>
                <p>Tus opiniones sobre nuestras experiencias</p>
            </div>
        ...
        <div class="content-wrapper">
            <div class="sidebar">
                ...
                <ul class="navigation">
                    ...
                    <li>
                        <a href="opiniones.php" class="active">
            ...
            <div class="main-content">
                <h2 class="section-title">
                    <i class="fas fa-star"></i> Tus Opiniones
                </h2>
                ...
                <div class="reviews-container">
                        ...
                        <?php foreach ($opiniones as $opinion): ?>
                            <div class="review-card">
                                <div class="review-header">
                                    <img src="<?php echo $opinion['imagen_principal'] ?: 'https://via.placeholder.com/80'; ?>" alt="Tour" class="tour-image">
                                    <div class="tour-info">
                                        <div class="tour-name"><?php echo htmlspecialchars($opinion['tour_nombre']); ?></div>
                                        <div class="review-date"><?php echo date('d/m/Y', strtotime($opinion['fecha'])); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="review-rating">
                                    ...
                                    for ($i = 1; $i <= 5; $i++): ?>
                                        <i class="fas fa-star <?php echo $i <= $calificacion ? 'star' : ''; ?>"></i>
                                    <?php endfor; ?>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="no-reviews">
                            ...
                            <p>No has realizado ninguna opinión</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
